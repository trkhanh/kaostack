...
You are producing one candidate design in architect's parallel exploration. Read the **[[_ai/_skill/pstack/architect/SKILL]]** in full first. That's the workflow you're inside. Output a candidate design package: type sketch, function signatures, module map, and prose rationale shaped per [[rationale-template]]
