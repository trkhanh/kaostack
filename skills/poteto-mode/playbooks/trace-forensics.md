...
1. Identify the format and load it with the right tool. Parse large artifacts in a subagent (the **[[_ai/_skill/kaostack/skills/principle-guard-the-context-window/SKILL|principle-guard-the-context-window]]** skill) and keep the reduced finding in the main thread.
