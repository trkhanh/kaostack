...
5. Verify the inherited claims against the original goal on the real artifact (the **[[_ai/_skill/kaostack/skills/principle-prove-it-works/SKILL|principle-prove-it-works]]** skill). A passing prior self-report is not the proof.
