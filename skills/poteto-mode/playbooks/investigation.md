...
1. Route through the [[_ai/_skill/kaostack/skills/how/SKILL|how]] skill. For motivation questions, also route through the [[_ai/_skill/kaostack/skills/why/SKILL|why]] skill.
...
4. Apply the [[_ai/_skill/kaostack/skills/unslop/SKILL|unslop]] skill to the reply.

No PR, no babysit, no [[_ai/_skill/kaostack/skills/architect/SKILL|architect]] unless the investigation precedes a code change. If it does, hand back to the user and re-route to Bug fix or Feature.
