...
name: automate-me
description: Guided flow that mines a user's agent-transcript history plus direct questions to author a personalized "-mode" skill (e.g. jay-mode) capturing their working conventions
...
This skill orchestrates three others: an inline mining pass (see step 1), Cursor's built-in `create-skill` (authoring), and the [[_ai/_skill/kaostack/skills/unslop/SKILL|unslop]] skill (prose discipline). It sequences them. It doesn't replace them.
...
The [[_ai/_skill/kaostack/skills/poteto-mode/SKILL|poteto-mode]] skill shows the shape. Read it for granularity. Don't copy its content. The user's rules are not the same as poteto-mode's.
...
Apply the [[_ai/_skill/kaostack/skills/unslop/SKILL|unslop]] skill and `create-skill`'s writing guidelines to every line.
