...
**Balance:** The bar is triviality, not repetition. A one-off still earns a lever when the lever is what makes the work checkable. Per the [[_ai/_skill/kaostack/skills/principle-laziness-protocol/SKILL|Laziness Protocol]], build the smallest script that does or proves the job, never a framework.

Distinct from [[_ai/_skill/kaostack/skills/principle-encode-lesson-in-structure/SKILL|Encode Lessons in Structure]], which makes a recurring instruction a durable guardrail. This is throughput and reviewability on the work in front of you. For scripting the verification itself, see [[_ai/_skill/kaostack/skills/principle-prove-it-works/SKILL|Prove It Works]].
